...
function crearClasePersona() {
  ...
  class Persona {
    ...
    getFriends() {
      ...
      var nombre = ((amigo) => amigo.nombre);
      var rAmigos = this.amigos.map(nombre);
      return rAmigos
    ...
    getPromedioEdad() {
      ...
      var total = this.amigos.map(amigo => amigo.edad).reduce((a, b) => a + b);
      var prome = total / this.amigos.length
      return prome
    }
